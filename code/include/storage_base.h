...
//      implement specific storage models (wrapper, based 2D, based 1D, offset) for testing.
//
...
//
inline char*
storage_model_base::first_segment_address() noexcept
{
    return sm_1d_base;
}

inline storage_model_base::size_type
storage_model_base::first_segment_size() noexcept
{
    return sm_1d_size;
}
